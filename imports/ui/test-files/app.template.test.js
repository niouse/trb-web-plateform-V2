...
import defaultStyles from "./../styles/app.styles.default.js";
...
if (Meteor.isClient) {
    ...
    describe('@Template (app.template.jsx)', function() {
        ...
        describe("text and styles are set correctly", function() {
            ...
            it('Styles provided via props.styles are correctly applied', function() {
                expect(wrapper.find('#app-title').props().style.color).to.equal("testColor");
            });
