...
export default function TrbRepairReport_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbRepairReport_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbRepairReport_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbRepairReport_Styles_Service
    }
} 
