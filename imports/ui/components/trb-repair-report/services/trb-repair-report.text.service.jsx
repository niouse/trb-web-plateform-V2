...
export default function TrbRepairReport_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbRepairReport_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbRepairReport_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbRepairReport_Text_Service
    }
}
