...
import Component from "./../trb-repair-report.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbRepairReport_Styles_Service} from "./../services/trb-repair-report.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-repair-report.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-repair-report-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-repair-report-" + key)
