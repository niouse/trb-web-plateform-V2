...
import Component from "./../signup.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Signup_Styles_Service} from "./../services/signup.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (signup.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("signup-" + key)
