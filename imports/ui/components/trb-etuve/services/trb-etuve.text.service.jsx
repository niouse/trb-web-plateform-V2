...
export default function TrbEtuve_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbEtuve_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbEtuve_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbEtuve_Text_Service
    }
}
