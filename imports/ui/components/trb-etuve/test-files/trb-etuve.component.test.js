...
import Component from "./../trb-etuve.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbEtuve_Styles_Service} from "./../services/trb-etuve.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-etuve.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-etuve-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-etuve-" + key)
