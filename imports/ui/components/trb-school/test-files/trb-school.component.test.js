...
import Component from "./../trb-school.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbSchool_Styles_Service} from "./../services/trb-school.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-school.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-school-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-school-" + key)
