...
export default function TrbSchool_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbSchool_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbSchool_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbSchool_Styles_Service
    }
} 
