...
export default function TrbSchool_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbSchool_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbSchool_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbSchool_Text_Service
    }
}
