...
import Component from "./../app-help.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {AppHelp_Styles_Service} from "./../services/app-help.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (app-help.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("app-help-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("app-help-" + key)
