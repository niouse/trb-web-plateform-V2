...
export default function AppHelp_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $AppHelp_Styles_Service extends Component {
            constructor(props) {
                super(props)
