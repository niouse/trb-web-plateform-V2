...
export default function AppHelp_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $AppHelp_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $AppHelp_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $AppHelp_Text_Service
    }
}
