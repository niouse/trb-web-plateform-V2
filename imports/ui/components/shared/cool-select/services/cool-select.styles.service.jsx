...
export default function CoolSelect_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $CoolSelect_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $CoolSelect_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $CoolSelect_Styles_Service
    }
} 
