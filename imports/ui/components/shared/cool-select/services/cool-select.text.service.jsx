...
export default function CoolSelect_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $CoolSelect_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $CoolSelect_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $CoolSelect_Text_Service
    }
}
