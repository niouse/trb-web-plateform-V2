...
import mockItems from "./services/cool-select.mocks.js"
import MocksService from "./services/cool-select.mocks.service.jsx"

export default function CoolSelect(IconButton, $TabHover){
	return (wrappedComponent)=>{
		@MocksService(mockItems)
