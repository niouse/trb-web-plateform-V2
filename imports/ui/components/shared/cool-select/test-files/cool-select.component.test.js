...
import Component from "./../cool-select.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {CoolSelect_Styles_Service} from "./../services/cool-select.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (cool-select.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("cool-select-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("cool-select-" + key)
