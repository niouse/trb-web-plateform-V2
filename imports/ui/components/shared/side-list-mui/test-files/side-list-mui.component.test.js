...
import Component from "./../side-list-mui.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {SideListMui_Styles_Service} from "./../services/side-list-mui.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (side-list-mui.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("side-list-mui-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("side-list-mui-" + key)
