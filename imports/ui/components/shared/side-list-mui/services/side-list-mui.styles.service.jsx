...
export default function SideListMui_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $SideListMui_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $SideListMui_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $SideListMui_Styles_Service
    }
} 
