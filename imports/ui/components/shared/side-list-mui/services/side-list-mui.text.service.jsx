...
export default function SideListMui_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $SideListMui_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $SideListMui_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $SideListMui_Text_Service
    }
}
