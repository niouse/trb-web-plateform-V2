...
export default function SideBoxHidden_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $SideBoxHidden_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $SideBoxHidden_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $SideBoxHidden_Text_Service
    }
}
