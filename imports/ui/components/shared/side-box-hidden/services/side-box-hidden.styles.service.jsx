...
export default function SideBoxHidden_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $SideBoxHidden_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $SideBoxHidden_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $SideBoxHidden_Styles_Service
    }
} 
