...
import Component from "./../side-box-hidden.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {SideBoxHidden_Styles_Service} from "./../services/side-box-hidden.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (side-box-hidden.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("side-box-hidden-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("side-box-hidden-" + key)
