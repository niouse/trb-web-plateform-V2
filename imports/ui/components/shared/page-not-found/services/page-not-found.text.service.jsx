...
export default function PageNotFound_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $PageNotFound_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $PageNotFound_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $PageNotFound_Text_Service
    }
}
