...
export default function PageNotFound_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $PageNotFound_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $PageNotFound_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $PageNotFound_Styles_Service
    }
} 
