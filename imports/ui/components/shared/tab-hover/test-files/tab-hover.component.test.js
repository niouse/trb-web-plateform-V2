...
import Component from "./../tab-hover.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TabHover_Styles_Service} from "./../services/tab-hover.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (tab-hover.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("tab-hover-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("tab-hover-" + key)
