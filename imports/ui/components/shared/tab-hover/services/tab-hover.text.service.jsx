...
export default function TabHover_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TabHover_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TabHover_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TabHover_Text_Service
    }
}
