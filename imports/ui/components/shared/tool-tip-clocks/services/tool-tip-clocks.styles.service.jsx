...
export default function ToolTipClocks_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
       

        class $ToolTipClocks_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $ToolTipClocks_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $ToolTipClocks_Styles_Service
    }
} 
