...
export default function ToolTipClocks_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $ToolTipClocks_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $ToolTipClocks_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $ToolTipClocks_Text_Service
    }
}
