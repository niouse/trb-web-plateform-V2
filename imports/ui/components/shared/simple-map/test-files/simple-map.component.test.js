...
import Component from "./../simple-map.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {SimpleMap_Styles_Service} from "./../services/simple-map.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (simple-map.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("simple-map-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("simple-map-" + key)
