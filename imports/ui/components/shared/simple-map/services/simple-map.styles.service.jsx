...
export default function SimpleMap_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $SimpleMap_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $SimpleMap_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $SimpleMap_Styles_Service
    }
} 
