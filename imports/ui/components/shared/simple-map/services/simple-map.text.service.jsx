...
export default function SimpleMap_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $SimpleMap_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $SimpleMap_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $SimpleMap_Text_Service
    }
}
