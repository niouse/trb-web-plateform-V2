...
export default function TrbWhiteboard_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbWhiteboard_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbWhiteboard_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbWhiteboard_Styles_Service
    }
} 
