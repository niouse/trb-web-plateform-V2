...
export default function TrbWhiteboard_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbWhiteboard_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbWhiteboard_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbWhiteboard_Text_Service
    }
}
