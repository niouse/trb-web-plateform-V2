...
import Component from "./../trb-whiteboard.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbWhiteboard_Styles_Service} from "./../services/trb-whiteboard.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-whiteboard.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-whiteboard-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-whiteboard-" + key)
