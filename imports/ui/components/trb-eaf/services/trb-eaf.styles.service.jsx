...
export default function TrbEaf_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbEaf_Styles_Service extends Component {
            constructor(props) {
                super(props)
