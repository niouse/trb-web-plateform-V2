...
import Component from "./../trb-eaf.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbEaf_Styles_Service} from "./../services/trb-eaf.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-eaf.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-eaf-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-eaf-" + key)
