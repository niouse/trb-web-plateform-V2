...
import Component from "./../app-container.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {AppContainer_Styles_Service} from "./../services/app-container.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (app-container.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("app-container-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("app-container-" + key)
