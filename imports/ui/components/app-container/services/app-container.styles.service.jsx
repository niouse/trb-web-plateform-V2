...
export default function AppContainer_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $AppContainer_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $AppContainer_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $AppContainer_Styles_Service
    }
} 
