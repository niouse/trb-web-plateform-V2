...
export default function AppContainer_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $AppContainer_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $AppContainer_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $AppContainer_Text_Service
    }
}
