...
import Component from "./../trb-youtube.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbYoutube_Styles_Service} from "./../services/trb-youtube.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-youtube.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-youtube-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-youtube-" + key)
