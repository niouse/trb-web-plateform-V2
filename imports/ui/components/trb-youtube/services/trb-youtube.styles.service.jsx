...
export default function TrbYoutube_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbYoutube_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbYoutube_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbYoutube_Styles_Service
    }
} 
