...
export default function TrbYoutube_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbYoutube_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbYoutube_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbYoutube_Text_Service
    }
}
