...
export default function TrbNewCampaign_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbNewCampaign_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbNewCampaign_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbNewCampaign_Styles_Service
    }
} 
