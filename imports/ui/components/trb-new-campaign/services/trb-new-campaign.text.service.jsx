...
export default function TrbNewCampaign_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbNewCampaign_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbNewCampaign_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbNewCampaign_Text_Service
    }
}
