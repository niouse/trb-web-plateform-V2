...
import Component from "./../trb-new-campaign.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbNewCampaign_Styles_Service} from "./../services/trb-new-campaign.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-new-campaign.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-new-campaign-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-new-campaign-" + key)
