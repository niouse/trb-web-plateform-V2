...
import Component from "./../trb-chantier.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbChantier_Styles_Service} from "./../services/trb-chantier.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-chantier.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-chantier-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-chantier-" + key)
