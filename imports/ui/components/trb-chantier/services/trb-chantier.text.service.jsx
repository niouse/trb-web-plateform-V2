...
export default function TrbChantier_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbChantier_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbChantier_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbChantier_Text_Service
    }
}
