...
export default function TrbChantier_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbChantier_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbChantier_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbChantier_Styles_Service
    }
} 
