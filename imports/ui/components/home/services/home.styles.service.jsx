...
export default function Home_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $Home_Styles_Service extends Component {
            constructor(props) {
                super(props)
