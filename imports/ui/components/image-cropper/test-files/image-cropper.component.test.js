...
import Component from "./../image-cropper.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {ImageCropper_Styles_Service} from "./../services/image-cropper.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (image-cropper.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("image-cropper-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("image-cropper-" + key)
