...
export default function ImageCropper_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $ImageCropper_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $ImageCropper_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $ImageCropper_Text_Service
    }
}
