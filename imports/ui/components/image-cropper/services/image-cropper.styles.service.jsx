...
export default function ImageCropper_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $ImageCropper_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $ImageCropper_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $ImageCropper_Styles_Service
    }
} 
