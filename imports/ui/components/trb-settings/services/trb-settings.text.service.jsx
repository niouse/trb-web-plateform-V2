...
export default function TrbSettings_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbSettings_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbSettings_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbSettings_Text_Service
    }
}
