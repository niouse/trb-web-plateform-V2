...
export default function TrbSettings_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbSettings_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbSettings_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbSettings_Styles_Service
    }
} 
