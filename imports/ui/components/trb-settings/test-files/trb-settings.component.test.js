...
import Component from "./../trb-settings.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbSettings_Styles_Service} from "./../services/trb-settings.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-settings.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-settings-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-settings-" + key)
