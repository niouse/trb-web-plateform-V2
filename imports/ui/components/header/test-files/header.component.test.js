...
import Component from "./../header.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Header_Styles_Service} from "./../services/header.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (header.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("header-" + key)
