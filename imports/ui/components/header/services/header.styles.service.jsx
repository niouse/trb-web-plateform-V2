...
export default function Header_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $Header_Styles_Service extends Component {
            constructor(props) {
                super(props)
