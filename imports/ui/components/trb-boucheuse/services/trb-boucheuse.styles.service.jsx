...
export default function TrbBoucheuse_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbBoucheuse_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbBoucheuse_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbBoucheuse_Styles_Service
    }
} 
