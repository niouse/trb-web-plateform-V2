...
export default function TrbBoucheuse_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbBoucheuse_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbBoucheuse_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbBoucheuse_Text_Service
    }
}
