...
import Component from "./../trb-boucheuse.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbBoucheuse_Styles_Service} from "./../services/trb-boucheuse.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-boucheuse.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-boucheuse-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-boucheuse-" + key)
