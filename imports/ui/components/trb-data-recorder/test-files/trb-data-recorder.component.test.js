...
import Component from "./../trb-data-recorder.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbDataRecorder_Styles_Service} from "./../services/trb-data-recorder.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-data-recorder.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-data-recorder-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-data-recorder-" + key)
