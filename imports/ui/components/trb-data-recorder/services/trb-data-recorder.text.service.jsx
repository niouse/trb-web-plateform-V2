...
export default function TrbDataRecorder_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbDataRecorder_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbDataRecorder_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbDataRecorder_Text_Service
    }
}
