...
export default function TrbDataRecorder_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbDataRecorder_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbDataRecorder_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbDataRecorder_Styles_Service
    }
} 
