...
import Component from "./../login.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Login_Styles_Service} from "./../services/login.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (login.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("login-" + key)
