...
export default function TrbDataVis_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbDataVis_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbDataVis_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbDataVis_Styles_Service
    }
} 
