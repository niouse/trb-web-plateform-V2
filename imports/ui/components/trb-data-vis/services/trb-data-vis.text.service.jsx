...
export default function TrbDataVis_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbDataVis_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbDataVis_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbDataVis_Text_Service
    }
}
