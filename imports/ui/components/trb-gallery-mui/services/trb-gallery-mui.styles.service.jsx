...
export default function TrbGalleryMui_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbGalleryMui_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbGalleryMui_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbGalleryMui_Styles_Service
    }
} 
