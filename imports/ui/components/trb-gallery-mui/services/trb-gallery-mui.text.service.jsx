...
export default function TrbGalleryMui_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbGalleryMui_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbGalleryMui_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbGalleryMui_Text_Service
    }
}
