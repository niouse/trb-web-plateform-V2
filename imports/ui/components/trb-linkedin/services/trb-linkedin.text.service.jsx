...
export default function TrbLinkedin_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbLinkedin_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbLinkedin_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbLinkedin_Text_Service
    }
}
