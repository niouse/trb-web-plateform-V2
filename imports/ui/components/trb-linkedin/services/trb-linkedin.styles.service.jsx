...
export default function TrbLinkedin_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbLinkedin_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbLinkedin_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbLinkedin_Styles_Service
    }
} 
