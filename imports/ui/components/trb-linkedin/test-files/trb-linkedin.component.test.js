...
import Component from "./../trb-linkedin.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbLinkedin_Styles_Service} from "./../services/trb-linkedin.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-linkedin.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-linkedin-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-linkedin-" + key)
