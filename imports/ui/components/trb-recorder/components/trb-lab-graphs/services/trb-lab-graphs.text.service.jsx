...
export default function TrbLabGraphs_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbLabGraphs_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbLabGraphs_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbLabGraphs_Text_Service
    }
}
