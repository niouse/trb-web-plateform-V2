...
export default function TrbLabGraphs_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbLabGraphs_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbLabGraphs_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbLabGraphs_Styles_Service
    }
} 
