...
export default function TrbLabSettings_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbLabSettings_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbLabSettings_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbLabSettings_Text_Service
    }
}
