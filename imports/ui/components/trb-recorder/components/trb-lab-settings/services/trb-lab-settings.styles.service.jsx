...
export default function TrbLabSettings_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbLabSettings_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbLabSettings_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbLabSettings_Styles_Service
    }
} 
