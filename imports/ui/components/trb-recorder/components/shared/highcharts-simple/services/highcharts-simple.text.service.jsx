...
export default function HighchartsSimple_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $HighchartsSimple_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $HighchartsSimple_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $HighchartsSimple_Text_Service
    }
}
