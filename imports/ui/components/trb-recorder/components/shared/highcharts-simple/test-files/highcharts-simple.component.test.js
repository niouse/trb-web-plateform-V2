...
import Component from "./../highcharts-simple.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {HighchartsSimple_Styles_Service} from "./../services/highcharts-simple.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (highcharts-simple.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("highcharts-simple-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("highcharts-simple-" + key)
