...
export default function Loading_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $Loading_Styles_Service extends Component {
            constructor(props) {
                super(props)
