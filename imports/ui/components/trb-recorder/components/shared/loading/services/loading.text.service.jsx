...
export default function Loading_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $Loading_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $Loading_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $Loading_Text_Service
    }
}
