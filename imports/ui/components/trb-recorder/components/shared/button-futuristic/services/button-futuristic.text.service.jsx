...
export default function ButtonFuturistic_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $ButtonFuturistic_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $ButtonFuturistic_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $ButtonFuturistic_Text_Service
    }
}
