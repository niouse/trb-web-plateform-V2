...
export default function TrbLabRecorderEdit_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbLabRecorderEdit_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbLabRecorderEdit_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbLabRecorderEdit_Text_Service
    }
}
