...
export default function TrbLabRecorderEdit_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbLabRecorderEdit_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbLabRecorderEdit_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbLabRecorderEdit_Styles_Service
    }
} 
