...
import Component from "./../trb-lab-recorder-edit.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbLabRecorderEdit_Styles_Service} from "./../services/trb-lab-recorder-edit.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-lab-recorder-edit.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-lab-recorder-edit-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-lab-recorder-edit-" + key)
