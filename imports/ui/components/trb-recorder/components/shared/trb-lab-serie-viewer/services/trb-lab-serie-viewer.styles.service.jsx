...
export default function TrbLabSerieViewer_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbLabSerieViewer_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbLabSerieViewer_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbLabSerieViewer_Styles_Service
    }
} 
