...
export default function TrbLabSerieViewer_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbLabSerieViewer_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbLabSerieViewer_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbLabSerieViewer_Text_Service
    }
}
