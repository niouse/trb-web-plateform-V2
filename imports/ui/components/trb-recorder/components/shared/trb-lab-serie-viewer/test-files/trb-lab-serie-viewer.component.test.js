...
import Component from "./../trb-lab-serie-viewer.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbLabSerieViewer_Styles_Service} from "./../services/trb-lab-serie-viewer.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-lab-serie-viewer.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-lab-serie-viewer-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-lab-serie-viewer-" + key)
