...
export default function TrbLabRecorder_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbLabRecorder_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbLabRecorder_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbLabRecorder_Styles_Service
    }
} 
