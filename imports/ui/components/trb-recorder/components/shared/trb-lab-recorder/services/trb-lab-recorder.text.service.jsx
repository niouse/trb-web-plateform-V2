...
export default function TrbLabRecorder_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbLabRecorder_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbLabRecorder_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbLabRecorder_Text_Service
    }
}
