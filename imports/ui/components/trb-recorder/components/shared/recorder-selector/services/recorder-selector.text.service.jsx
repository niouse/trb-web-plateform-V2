...
export default function RecorderSelector_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $RecorderSelector_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $RecorderSelector_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $RecorderSelector_Text_Service
    }
}
