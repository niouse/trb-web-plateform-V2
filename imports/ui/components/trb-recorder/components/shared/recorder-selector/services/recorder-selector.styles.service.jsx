...
export default function RecorderSelector_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $RecorderSelector_Styles_Service extends Component {
            constructor(props) {
                super(props)
			...
			componentWillRecievNewProps(newProps){
				if(newProps.stylesOptions){
					this.setState({
						styles: computeStyles(defaultStyles, newProps.stylesOptions, this.userStyles)
					})
				}
			}
        ...
        $RecorderSelector_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $RecorderSelector_Styles_Service
    }
} 
