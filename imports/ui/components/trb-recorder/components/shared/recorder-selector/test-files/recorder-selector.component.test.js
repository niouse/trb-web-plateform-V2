...
import Component from "./../recorder-selector.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {RecorderSelector_Styles_Service} from "./../services/recorder-selector.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (recorder-selector.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("recorder-selector-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("recorder-selector-" + key)
