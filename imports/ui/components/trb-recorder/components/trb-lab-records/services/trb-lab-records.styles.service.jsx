...
export default function TrbLabRecords_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbLabRecords_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbLabRecords_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbLabRecords_Styles_Service
    }
} 
