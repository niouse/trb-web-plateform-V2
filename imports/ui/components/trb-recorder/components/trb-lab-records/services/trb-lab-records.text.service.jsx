...
export default function TrbLabRecords_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbLabRecords_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbLabRecords_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbLabRecords_Text_Service
    }
}
