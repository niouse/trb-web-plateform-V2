...
export default function TrbLabDashboard_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbLabDashboard_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbLabDashboard_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbLabDashboard_Styles_Service
    }
} 
