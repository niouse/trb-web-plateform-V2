...
export default function TrbLabDashboard_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbLabDashboard_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbLabDashboard_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbLabDashboard_Text_Service
    }
}
