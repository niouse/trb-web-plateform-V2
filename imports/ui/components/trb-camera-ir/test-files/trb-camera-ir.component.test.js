...
import Component from "./../trb-camera-ir.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbCameraIr_Styles_Service} from "./../services/trb-camera-ir.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-camera-ir.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-camera-ir-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-camera-ir-" + key)
