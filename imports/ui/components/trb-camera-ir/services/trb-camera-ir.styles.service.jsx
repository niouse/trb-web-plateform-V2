...
export default function TrbCameraIr_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbCameraIr_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbCameraIr_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbCameraIr_Styles_Service
    }
} 
