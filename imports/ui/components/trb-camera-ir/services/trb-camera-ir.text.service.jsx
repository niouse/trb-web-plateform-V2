...
export default function TrbCameraIr_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbCameraIr_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbCameraIr_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbCameraIr_Text_Service
    }
}
