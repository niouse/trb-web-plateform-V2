...
export default function TrbSearch_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbSearch_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbSearch_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbSearch_Text_Service
    }
}
