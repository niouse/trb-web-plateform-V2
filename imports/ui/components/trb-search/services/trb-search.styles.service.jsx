...
export default function TrbSearch_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbSearch_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbSearch_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbSearch_Styles_Service
    }
} 
