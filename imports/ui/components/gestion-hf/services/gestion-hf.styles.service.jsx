...
export default function GestionHf_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $GestionHf_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $GestionHf_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $GestionHf_Styles_Service
    }
} 
