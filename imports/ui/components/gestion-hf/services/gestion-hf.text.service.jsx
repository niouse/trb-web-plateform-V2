...
export default function GestionHf_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $GestionHf_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $GestionHf_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $GestionHf_Text_Service
    }
}
