...
export default function TrbGalleryThreeD_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbGalleryThreeD_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbGalleryThreeD_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbGalleryThreeD_Styles_Service
    }
} 
