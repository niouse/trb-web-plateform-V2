...
export default function TrbGalleryThreeD_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbGalleryThreeD_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbGalleryThreeD_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbGalleryThreeD_Text_Service
    }
}
