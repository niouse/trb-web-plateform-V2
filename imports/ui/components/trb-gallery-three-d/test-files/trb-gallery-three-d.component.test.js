...
import Component from "./../trb-gallery-three-d.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbGalleryThreeD_Styles_Service} from "./../services/trb-gallery-three-d.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-gallery-three-d.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-gallery-three-d-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-gallery-three-d-" + key)
