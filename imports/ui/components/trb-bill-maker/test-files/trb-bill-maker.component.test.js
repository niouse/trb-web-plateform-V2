...
import Component from "./../trb-bill-maker.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbBillMaker_Styles_Service} from "./../services/trb-bill-maker.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-bill-maker.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-bill-maker-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-bill-maker-" + key)
