...
export default function TrbBillMaker_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbBillMaker_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbBillMaker_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbBillMaker_Styles_Service
    }
} 
