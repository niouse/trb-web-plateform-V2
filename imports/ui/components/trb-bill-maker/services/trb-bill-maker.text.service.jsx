...
export default function TrbBillMaker_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbBillMaker_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbBillMaker_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbBillMaker_Text_Service
    }
}
