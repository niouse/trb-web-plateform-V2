...
import Component from "./../world-cities.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {WorldCities_Styles_Service} from "./../services/world-cities.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (world-cities.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("world-cities-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("world-cities-" + key)
