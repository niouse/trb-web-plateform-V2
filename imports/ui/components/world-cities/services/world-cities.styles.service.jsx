...
export default function WorldCities_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $WorldCities_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $WorldCities_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $WorldCities_Styles_Service
    }
} 
