...
export default function WorldCities_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $WorldCities_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $WorldCities_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $WorldCities_Text_Service
    }
}
