...
import Component from "./../trb-chat.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbChat_Styles_Service} from "./../services/trb-chat.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-chat.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-chat-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-chat-" + key)
