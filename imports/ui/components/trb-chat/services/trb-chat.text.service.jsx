...
export default function TrbChat_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbChat_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbChat_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbChat_Text_Service
    }
}
