...
export default function TrbChat_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbChat_Styles_Service extends Component {
            constructor(props) {
                super(props)
