...
export default function TrbMail_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbMail_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbMail_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbMail_Text_Service
    }
}
