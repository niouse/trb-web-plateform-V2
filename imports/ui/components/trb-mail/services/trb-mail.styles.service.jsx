...
export default function TrbMail_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbMail_Styles_Service extends Component {
            constructor(props) {
                super(props)
