...
export default function TrbInstrumRm_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbInstrumRm_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbInstrumRm_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbInstrumRm_Text_Service
    }
}
