...
export default function TrbInstrumRm_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbInstrumRm_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbInstrumRm_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbInstrumRm_Styles_Service
    }
} 
