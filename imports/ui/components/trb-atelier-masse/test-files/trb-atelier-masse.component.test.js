...
import Component from "./../trb-atelier-masse.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbAtelierMasse_Styles_Service} from "./../services/trb-atelier-masse.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-atelier-masse.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-atelier-masse-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-atelier-masse-" + key)
