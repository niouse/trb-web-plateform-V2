...
export default function TrbAtelierMasse_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbAtelierMasse_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbAtelierMasse_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbAtelierMasse_Styles_Service
    }
} 
