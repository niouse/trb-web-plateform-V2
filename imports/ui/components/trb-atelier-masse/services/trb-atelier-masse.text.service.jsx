...
export default function TrbAtelierMasse_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbAtelierMasse_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbAtelierMasse_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbAtelierMasse_Text_Service
    }
}
