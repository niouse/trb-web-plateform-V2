...
export default function TrbCurrencyConvert_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbCurrencyConvert_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbCurrencyConvert_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbCurrencyConvert_Text_Service
    }
}
