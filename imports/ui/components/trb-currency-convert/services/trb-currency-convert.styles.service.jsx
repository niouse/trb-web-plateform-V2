...
export default function TrbCurrencyConvert_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $TrbCurrencyConvert_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbCurrencyConvert_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbCurrencyConvert_Styles_Service
    }
} 
