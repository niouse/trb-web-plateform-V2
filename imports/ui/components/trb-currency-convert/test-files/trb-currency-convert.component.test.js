...
import Component from "./../trb-currency-convert.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbCurrencyConvert_Styles_Service} from "./../services/trb-currency-convert.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-currency-convert.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-currency-convert-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-currency-convert-" + key)
