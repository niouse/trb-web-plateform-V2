...
export default function WebPage_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $WebPage_Styles_Service extends Component {
            constructor(props) {
                super(props)
