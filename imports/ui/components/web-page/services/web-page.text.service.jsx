...
export default function WebPage_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $WebPage_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $WebPage_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $WebPage_Text_Service
    }
}
