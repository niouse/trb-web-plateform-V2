...
import Component from "./../trb-map.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbMap_Styles_Service} from "./../services/trb-map.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-map.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-map-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-map-" + key)
