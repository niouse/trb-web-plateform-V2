...
export default function DropUpAll(_optional) {
    return (WrappedComponent) => {
        class $DropUpAll extends Component {
            constructor(props) {
                super(props);
                this.state = {}
            }
